...
import samplePicture from '../../public/samplepic.png';
		...
		<div>
			...
			<section>
				<div className={styles.devContainer}>
					...
					<p>
						...
						お子さんの名前や愛称を入力すると、明るい言葉や動物のお話を組み合わせて日本語と英語で話しかけます。
					</p>
			...
			<section>
				<div className={styles.devContainer}>
					...
					<p>
						Baby Talk AIは育児休暇を取得した非エンジニアが知識ゼロから開発を学び、育児の合間に作成したWebアプリケーションです。<br/>
						育児中に風邪を引いて声が出なくなった際に、子供に話しかけてくれるAIが欲しいと思い開発をスタートしました。育児をされている方々に少しでも癒しを与え、手助けになれば幸いです。<br/>
						<br/>
			...
			<section>
				<div className={styles.devContainer}>
					...
					<p>
						AIは育児領域で様々な価値を提供できる可能性を秘めています。<br/>
						例えば数年後には子供のお気に入りのおもちゃにLLMが搭載され、子供と話してくれるようになるのではないでしょうか。<br/>
						<br/>
						Baby Talk AIを体験していただき、感想や要望がありましたら是非以下のメールアドレスにご連絡ください。<br/>
